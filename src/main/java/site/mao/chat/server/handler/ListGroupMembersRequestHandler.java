...
import site.mao.chat.protocol.packet.ListGroupMembersRequestPacket;
import site.mao.chat.protocol.packet.ListGroupMembersResponsePacket;
...
public class ListGroupMembersRequestHandler extends SimpleChannelInboundHandler<ListGroupMembersRequestPacket> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ListGroupMembersRequestPacket requestPacket) throws Exception {
        ...
        for (Channel channel : channelGroup) {
            Session session = SessionMap.getSession(channel);
